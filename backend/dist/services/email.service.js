...
exports.sendTicketConfirmationEmail = exports.sendWelcomeEmail = exports.sendEmail = void 0;
 ...
 * @returns {Promise<any>} - Nodemailer response
 */
const sendTicketConfirmationEmail = async (to, name, eventTitle, ticketNumber, eventDate, venueName) => {
    return (0, exports.sendEmail)({
        to,
